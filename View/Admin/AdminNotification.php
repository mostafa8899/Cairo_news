...
require_once '../../Controllers/NotificationController.php';
 ...
 $NotificationView=$NotificationController->getAllNotification();
$n=1;
...
$articleController=new NotificationController;
$Notifications->content=$_POST['content'];

 if($articleController->sendNotification($Notifications))
  {
 ...
 if (isset($_POST["delete"])) {
   if (!empty($_POST["NotificationID"])) {
    ...
    $Notification->setNotificationID($_POST["NotificationID"]);
     if ($NotificationController->deletenotification($Notification)) {
       $deleteMsg = true;
       $NotificationView=$NotificationController->getAllNotification();
       ...
       <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y ">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Notifications</span></h4>
               ...
               <div class="card">
                ...
                <div class="col-md-8">
            <div class="card mb-2">
              <h4 class="mb-2">Add Notification </h4>
              <?php 
            ...
            <form id="formAuthentication" class="card-body" action="AdminNotification.php" method="POST">
              <div class="mb-3">
                <label for="content" class="form-label">UserName</label>
                <textarea type="text" class="form-control" id="content" name="content" placeholder="Enter Notification" autofocus></textarea>
              </div>
           ...
           <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">My Notification</span></h4>
       <?php
       foreach ($NotificationView as $Notifications) {
         ?>
         <div class="card mb-3">
 <div class="card-body">
   
   <p class="card-text"><?php echo $Notifications['content']?></p>
   <form id="formAuthentication"  action="AdminNotification.php" method="POST">         
<input type="hidden" id="NotificationID" name="NotificationID" value="<?php echo $Notifications['NotificationID'] ?>">
