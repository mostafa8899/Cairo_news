...
$Notification=$NotificationController->getAllNotification();
$n=1;
$errMsg = "";
?>
        ...
        <div class="layout-page">
          ...
          <!-- / Navbar -->
              ...
              <div class="card">
                ...
                <div class="card mb-4">
                <h5 class="card-header">Notification Section</h5>
                <div class="row g-0">
                   ...
                   foreach ($Notification as $Notification) {
                      ...
                      ?><div class="bs-toast toast fade show bg-dark" role="alert" aria-live="assertive" aria-atomic="true">
                        <div class="toast-header">
                          ...
                          <div class="me-auto fw-semibold"><?php  ?> </div>
                                        <small><?php
                                        $currentDate = date("Y-m-d");
                                        echo "Notfication ".$n++.". The current date is: " .date('l, F j, Y g:i A', strtotime($Notification['DateAdded']));
                                         ?></small>
