        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Art News</span></h4>
              <div class="row mb-5">
              <!-- Examples -->
              <?php
                ...
                <div class="col-md-6 col-lg-4 mb-3">
                  <div class="card h-100">
                    ...
                    <div class="card-body">
                      ...
                      <a href="thearticle.php?articleID=<?php echo $article['ArticleID'] ?>" class="btn btn-outline-primary">Details</a>
                    </div>
                  </div>
                </div>
              <?php
