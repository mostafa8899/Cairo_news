...
$article->SetArticleID($_SESSION['articleID']);
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="author.php" class="menu-link" >
                ...
                <div data-i18n="Analytics">authorPage</div>
              </a>
            </li>
            <li class="menu-item ">
            ...
            <li class="menu-item active ">
              <a href="editArticle.php" class="menu-link" >
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">edit Article Page</div>
              </a>
            </li>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            ?>
                      ...
                      <form id="formAuthentication" class="card-body" action="editArticle.php" method="POST"enctype="multipart/form-data" >
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="Content">New Content</label>
                           <div class="col-sm-10">
                             <textarea type="text" class="form-control" id="Content" name="Content" value ="<?php  echo $row['Content']; ?> " >  </textarea>
                           </div>
                  
                         <div class="row mb-3">
                           <label class="col-sm-3 form-label" for="category">New Category</label>
                           <div class="col-sm-9">
                               <div class="input-group input-group-merge">
                                   <select id="category" class="form-select form-select-lg" name="category"value ="<?php  echo $row['category']; ?>" >
                         ...
                         <div class="row mb-3">
                           <label class="col-sm-3 form-label" for="image">New image</label>
                           <div class="col-sm-9">
                               <div class="input-group input-group-merge">
