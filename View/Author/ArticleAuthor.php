...
$article=$Author_articleController->getArticle($user);
...
if (isset($_POST["delete"])) {
  ...
  if (!empty($_POST["ArticleID"])) {
    if ($articleController->delteArticle($articleID)) {
      $deleteMsg = true;
      $article=$Author_articleController->getArticle($user);
    ...
    <div class="col-md-6 col-lg-4 mb-3">
      <div class="card h-95">
        ...
        <div class="card-body">
          ...
          <a href="editArticle.php?articleID=<?php echo $article['ArticleID'] ?>" class="btn rounded-pill btn-dark">Update</a>
          <form action="ArticleAuthor.php" method="POST">
